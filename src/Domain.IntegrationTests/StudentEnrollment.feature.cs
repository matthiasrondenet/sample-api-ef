...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Student canno\'t enroll to an already started course")]
        [Xunit.TraitAttribute("FeatureTitle", "Student Enrollment")]
        [Xunit.TraitAttribute("Description", "Student canno\'t enroll to an already started course")]
        [Xunit.TraitAttribute("Category", "enrollment")]
        public virtual void StudentCannotEnrollToAnAlreadyStartedCourse()
        {
            string[] tagsOfScenario = new string[] {
                    "enrollment"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Student canno\'t enroll to an already started course", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 19
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
