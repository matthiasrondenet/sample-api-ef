...
namespace Api.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(int studentId)
        {
            ...
            if (student == null)
                return this.NotFound(studentId);
        ...
        {
            var student = new Student(createStudentRequest.LastName, createStudentRequest.LastName, createStudentRequest.Email);
